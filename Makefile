...
LIBFT := $(LIB)/ft_atoi.c $(LIB)/ft_memalloc.c $(LIB)/ft_putchar.c $(LIB)/ft_strcat.c $(LIB)/ft_striter.c $(LIB)/ft_strncmp.c          \
		...
		$(LIB)/ft_strnew_w.c $(LIB)/ft_strlen_w.c $(LIB)/ft_putstrw.c $(LIB)/ft_putsymbol.c $(LIB)/ft_strdupw.c
FILES :=  pf_main.c pf_spec_handlers.c pf_utils.c pf_flags.c pf_width_prec.c pf_dspec.c pf_uspec.c pf_extra.c
OBJ1 := $(LIBFT:.c=.o)
OBJ2 := $(FILES:.c=.o)
